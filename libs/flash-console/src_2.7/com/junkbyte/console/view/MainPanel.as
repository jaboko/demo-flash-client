...
package com.junkbyte.console.view
{
    ...
    public class MainPanel extends ConsolePanel
    {
        ...
        private function lineShouldShow(line:Log):Boolean
        {
            ...
            || (_filterText && _viewingChannels.indexOf(ConsoleChannel.FILTER_CHANNEL) >= 0 &&
                line.text.toLowerCase().indexOf(_filterText) >= 0 )
        ...
        private function addFilterText(txt:String):String
        {
            ...
            } else if (_filterText)
            {
                ...
                while (j >= 0)
                {
                    txt = txt.substring(0, j) + "<u>" + txt.substring(j, j + _filterText.length) + "</u>" +
                          txt.substring(j + _filterText.length);
